...
history = model.fit_generator(train_generator, validation_steps=len(validation_samples), epochs=3, validation_data=validation_generator, steps_per_epoch=len(train_samples))
